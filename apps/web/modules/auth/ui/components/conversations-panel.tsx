...
import { ListIcon, ArrowRightLeft, ArrowUpIcon, CheckIcon, CornerUpLeftIcon, ArrowRightIcon  } from 'lucide-react'
...
function ConversationsPanel() {
  ...
  return (
    <div className='flex h-full w-full flex-col bg-backgrouund text-sidebar-foreground'>
